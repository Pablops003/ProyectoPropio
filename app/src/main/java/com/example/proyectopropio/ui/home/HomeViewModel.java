...
public class HomeViewModel extends AndroidViewModel {
    ...
    public HomeViewModel(@NonNull Application application1){
        super(application1);
    ...
    private void fetchAddress(Location location) {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                Log.e("Pablo", resultMessage, ioException);
            } catch (IllegalArgumentException illegalArgumentException) {
                resultMessage = "Coordenades no vàlides";
                Log.e("Pablo", resultMessage + ". " + "Latitude = " + location.getLatitude() + ", Longitude = " + location.getLongitude(), illegalArgumentException);
            }
        });
    }
    ...
    public void setUser(FirebaseUser passedUsser){
        user.postValue(passedUsser);
    }
